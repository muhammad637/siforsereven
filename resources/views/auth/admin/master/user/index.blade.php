                    ...
                    <div class="card">
                        ...
                        <div class="card-header">
                            ...
                            @if (auth()->user()->cekLevel == 'admin')
                                <button type="button" class="btn bg-primary" data-toggle="modal" data-target="#modaltambah">
                                                    ...
                                                    <td>
                                                        ...
                                                        @else
                                                            <a href="{{ route('user.aktif', ['user' => $user->id]) }}"
                                                                class="badge bg-success " style="color: white"><i
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="modaleditLabel">Form edit User
                                                                </h5>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-4">
                                            ...
                                            <span class="input-group-text" id="mybutton"><i class="fa fa-eye"
                                                    aria-hidden="true" id="eye1"></i></span>
                                        </div>
                                    </div>
                                </div>
