            ...
            <div class="row align-items-center">
              <div class="col-7 col-md-8">
                <div class="">
                  ...
                  <p class="card-title" style="font-size: 2em;">{{$jumlahBarang}}<p>
                </div>
            ...
            <div class="row align-items-center">
              <div class="col-7 col-md-8">
                <div class="">
                  ...
                  <p class="card-title" style="font-size: 2em;">{{$orderOnprogress}}<p>
            ...
            <div class="row align-items-center">
              <div class="col-7 col-md-8">
                <div class="">
                  ...
                  <p class="card-title" style="font-size: 2em;">{{$users->count()}}<p>
                ...
                @endphp
                    <tr>
                      <td class="text-center">
                        {{ $parse($order->tanggal_order) }} <br>{{$parse_hour($order->created_at)}}
                      </td>
                      <td class="text-center">
